...
import { parseSocialHandles, parseContentCategories, parseAudienceMetrics, getDisplayLocation } from '@/types/influencer.types';
...
export default function InfluencerCard({ influencer }: InfluencerCardProps) {
  ...
  const primaryHandle = handles[influencer.primaryPlatform];
  ...
  return (
    <Card className="overflow-hidden hover:shadow-lg transition-shadow">
      <Link href={`/dashboard/influencers/${influencer.influencerId}`}>
        <div className="p-6">
          {/* Header */}
